...
#   Library
import socket, re, time, os, platform
...
#   Fuction check_os
def check_os():
    if "linux" in str(platform.platform()).lower(): # Check if platform is linux
        os.system("clear")
    else:
        os.system("cls")
        init(convert=True)
...
{red}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{reset}""")
            ...
            update_file(address, f"({address}:{port}) - ({players_on}/{players_max}) - ({version}) - ({motd})") # Call the fuction update_file
        except Exception:
            pass
        finally:
...
#   Fuction main
def main():
    check_os() # Call the fuction check_os
